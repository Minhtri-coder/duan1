...
public class OrderDetailsAdapter extends RecyclerView.Adapter<OrderDetailsAdapter.viewholder>{
    ...
    public class viewholder extends RecyclerView.ViewHolder {
        ...
        public viewholder(@NonNull View itemView) {
            super(itemView);
            imgOrderDetails = itemView.findViewById(R.id.itemImageView);
            txtName = itemView.findViewById(R.id.itemNameTextView);
            txtPrice = itemView.findViewById(R.id.itemPriceTextView);
            txtQuantity = itemView.findViewById(R.id.itemDetailsTextView);
